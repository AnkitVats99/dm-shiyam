...
import { Send, Mail, Lock, User, Eye, EyeOff, ArrowLeft, RefreshCw } from "lucide-react";
      ...
      <div className="w-full" style={{ maxWidth: 440 }}>
        ...
        <div className="rounded-2xl bg-white" style={{ border: "1px solid #d1d5db", padding: "28px 32px", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
          ...
          <button
            ...
            style={{ border: "1px solid #9ca3af", borderRadius: 12, padding: "12px 16px", whiteSpace: "nowrap" }}
          >
          ...
          <div className="text-center text-sm text-gray-500" style={{ marginTop: 20 }}>
            {isSignup ? (
              <>
                ...
                <button onClick={() => { setIsSignup(false); setError(""); }} className="font-semibold text-purple-600 hover:text-purple-700">
                  Sign in
                </button>
              </>
            ) : (
              <>
                ...
                <button onClick={() => { setIsSignup(true); setError(""); }} className="font-semibold text-purple-600 hover:text-purple-700">
                  Sign up free
                </button>
              </>
            )}
